...
if(isset($_SESSION["login"])) {
	exit(header("Location: \perbaikan\index.php"));
}
require 'config.php';
 if(isset($_POST['bsubmit'])) {
	 $username=$_POST["username"];
	 $password=$_POST["password"];
	 $result=mysqli_query ($db, " SELECT * FROM `tabel` WHERE username = '$username'");
  ...
  <body>
    <div class="grid">
      <form action="" method="post" class="form login">
        ...
        <button type="submit" value="Sign In" name="bsubmit"/>log In</button>
      </form>
